...
--
myWorkspaces    = ["\63083", "\63206", "\63306", "\63382", "\63589", "\63256", "\64271", "\63235", "阮"]
...
clipboardy = spawn "rofi -modi \"\63053 :greenclip print\" -show \"\63053 \" -run-command '{cmd}' -theme ~/.config/rofi/config/launcher.rasi"
...
maimcopy = spawn "maim -s | xclip -selection clipboard -t image/png && notify-send \"Screenshot\" \"Copied to Clipboard\" -i ~/.local/share/icons/fontawesome/screenshot.svg"
maimsave = spawn "maim -s ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png && notify-send \"Screenshot\" \"Saved to Screenshots\" -i ~/.local/share/icons/fontawesome/screenshot.svg"
rofi_launcher = spawn "sh $HOME/.config/rofi/bin/launcher"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- lock screen
    , ((modm,               xK_F1    ), spawn "betterlockscreen -l blur")
    ...
    , ((0,                    xF86XK_AudioRaiseVolume), update)
    , ((0,                    xF86XK_AudioLowerVolume), decade)
    ...
    -- Quit xmonad
    , ((modm .|. shiftMask, xK_q     ), spawn "sh $HOME/.config/rofi/bin/powermenu")
