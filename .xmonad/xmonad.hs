...
--
myWorkspaces    = ["\62211", "\63206", "\63306", "\61459", "\59036", "\63256", "\61684", "\61485", "\61441"]
...
maimcopy = spawn "maim -s | xclip -selection clipboard -t image/png && notify-send \"Screenshot\" \"Copied to Clipboard\" -i ~/.local/share/icons/mdi/screenshot.png"
maimsave = spawn "maim -s ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png && notify-send \"Screenshot\" \"Saved to Screenshots\" -i ~/.local/share/icons/mdi/screenshot.png"
